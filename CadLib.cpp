...
// Base Functions --------------------------------------------------
int CDxfFileWrite::WriteParameter( int GroupCode, LPCTSTR Value )
{
	ISLIBRARYLOADED();
	return dxfWriteParamString( m_hDxf, GroupCode, Value );
}

int CDxfFileWrite::WriteParameter( int GroupCode, double Value )
{
	ISLIBRARYLOADED();
	return dxfWriteParamDouble( m_hDxf, GroupCode, Value );
}

int CDxfFileWrite::WriteParameter( int GroupCode, int Value )
{
	ISLIBRARYLOADED();
